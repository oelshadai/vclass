      ...
      {!isMobile && (
        ...
        >
          ...
          <div style={{
            ...
            borderBottom: '1px solid var(--border-color)',
            paddingLeft: sidebarCollapsed ? 'var(--space-2)' : 'var(--space-4)',
            paddingRight: sidebarCollapsed ? 'var(--space-2)' : 'var(--space-4)',
            ...
            <button
              ...
              onMouseEnter={(e) => e.currentTarget.style.color = '#115e3d'}
              ...
              return (
                <Link
                  ...
                  style={{
                    ...
                    color: isActive ? '#115e3d' : 'var(--text-tertiary)',
                  ...
                  onMouseEnter={(e) => {
                    if (!isActive) {
                      e.currentTarget.style.backgroundColor = 'rgba(17, 94, 61, 0.05)'
                      e.currentTarget.style.color = '#115e3d'
                    }
                  }}
                  onMouseLeave={(e) => {
                    if (!isActive) {
